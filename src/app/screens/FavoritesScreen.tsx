...
export function FavoritesScreen({ onNavigate, onBack }: FavoritesScreenProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-background pb-32">
      {/* Header */}
      <div className="sticky top-0 z-20 border-b border-black/5 dark:border-white/5 bg-background/80 backdrop-blur-xl px-6 py-6 transition-all">
        <motion.div
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground tracking-tight">{t("nav.favorites")}</h1>
      ...
      <div className="px-6 py-8">
        {favoriteListings.length > 0 ? (
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold text-foreground">{t("profile.noFavorites")}</h3>
        ...
        {favoriteListings.length > 0 && (
          <motion.div
            ...
            className="mt-12 p-6 rounded-3xl bg-gradient-to-br from-cyan-500/10 to-blue-600/10 border border-black/5 dark:border-white/5"
          >
